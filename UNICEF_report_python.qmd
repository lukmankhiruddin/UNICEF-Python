...
# Create a comprehensive country name mapping dictionary for Asia
...
# Filter stunting data for Asian countries
stunting_data = combined_indicators[
    (combined_indicators['indicator'].str.contains('height.for.age|stunting', case=False, na=False)) &
    (~combined_indicators['obs_value'].isna()) &
    ((combined_indicators['sex'] == 'Total') | combined_indicators['sex'].isna())
]
...
fig.update_geos(
    ...
    showcoastlines=True,
    coastlinecolor="gray",
    center=dict(lat=30, lon=100),  # Center on Asia
    projection_scale=2.5  # Zoom in on Asia
)
